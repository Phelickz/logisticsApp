  ...
  Widget build(BuildContext context) {
    final pageList = [
      PageModel(
          ...
          body: Text(
              'We are capable of handling bulk deliveries. So you don\'t have to worry about size',
    ...
    return Scaffold(
      ...
      body: FancyOnBoarding(
        ...
        doneButtonTextStyle: GoogleFonts.aBeeZee(
          fontWeight: FontWeight.bold,
          color: Colors.white
        ),
        skipButtonText: "Skip",
        pageList: pageList,
        onDoneButtonPressed: () => Get.off(WelcomeScreen()),
        onSkipButtonPressed: () => Get.off(WelcomeScreen()),
      ),
    );
  }
}
